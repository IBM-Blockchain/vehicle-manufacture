    ...
    link: function (scope, element, attrs) {
      ...
      function addAlert() {
        ...
        var newAlert = alerts.enter()
          .filter(function(d,i) { return i === (scope.transactions.length -1)})
          .append('div')
        ...
        newAlert.append('div')
          ...
          .html(function(d) {
            return '<img class="bc-vda-new-block" src="regulator/assets/images/new_block.svg"/>'+
                 ...
                 '<p class="bc-vda-new-block-id">#'+d.block_number+'</p>'+
                 '<p class="bc-vda-new-block-new-vehicle-order">'+d.transaction_type+'</p>'
          })
          .style('opacity', 0);
