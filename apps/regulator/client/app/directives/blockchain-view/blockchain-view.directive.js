    ...
    link: function (scope, element, attrs) {
      ...
      function updateChart() {
        ...
        chart.transition().duration(1000).style('width', function() {
          var blocksWidth = (scope.transactions.length * (sizes.width + sizes.padding));
        ...
        newBlocks.append('div')
          ...
          .html(function (d) {
            return '<label class="block-label">'+'#'+ d.block_number + '</label>';
          })
          .style('opacity', 0);
        ...
        newBlocks.append('div')
          ...
          .html(function (d) {
            return '<label class="transactionDetails">TRANSACTION ID</label></br><span class="transactionDetails">' + d.transaction_id + '</span>';
          })
          .style('opacity', 0);
        ...
        newBlocks.append('div')
          ...
          .html(function (d) {
            return '<label class="transactionDetails">' + d.transaction_type + '</label></br><span class="transactionDetails">' + (d.additional_info ? d.additional_info : '') + '</span>';
          })
          .style('opacity', 0);
